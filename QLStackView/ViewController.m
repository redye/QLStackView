...
- (void)viewDidLoad {
    ...
    NSString *formatString = [NSString stringWithFormat:@"{vc(spacing:20,extendWith:-1)[%@][imageView(width:50,height:50)][(text:哈哈哈哈哈哈哈,line:0,color:#ff00ff,backgroundColor:#00ff00,cornerRadius:2,padding:10)][(width:100,height:100,backgroundColor:#ff0000,button:<button>)]}", imageViews2];
